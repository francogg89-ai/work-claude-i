"""Insumos sintéticos de los controles N12-N18.

Nunca se aplican al candidato real ni a la bitácora real: existen para demostrar que las
comprobaciones de cobertura, de sección, de forma, de identidad, de discriminación y de
ejecución única pueden fallar.
"""
...
# N17 y N18 usan bitácoras sintéticas, nunca la real.
N17_BITACORA = "BITACORA_N17.txt"
N18_BITACORA = "BITACORA_N18.txt"

CONTRATO_SINTETICO = "contrato-sintetico"
CANDIDATO_SINTETICO = "1" * 40
